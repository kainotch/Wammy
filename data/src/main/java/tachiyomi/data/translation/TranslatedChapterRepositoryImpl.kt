 ...
 *   <!-- wammy-meta:engineId:dateTranslated -->
 *
...
class TranslatedChapterRepositoryImpl(
    ...
    /** Legacy (app-internal) directory â€“ used for fallback and migration. */
     ...
     * Safe to call multiple times â€“ it only moves files that still exist in the legacy dir.
     */
    ...
    private val metaPrefix = "<!-- wammy-meta:"
    private val metaSuffix = " -->"
    private val metaRegex = Regex("^<!-- wammy-meta:(.+?):(-?\\d+)(?::([a-f0-9]{64}))? -->\\n?")
