...
class NovelWebViewChapterMetaTest {
    ...
    // buildWammyScript: assembled script contains all keys

    @Test
    fun `buildWammyScript includes the required Wammy keys`() {
        val script = NovelWebViewChapterMeta.buildWammyScript(
            NovelWebViewChapterMeta.WammyScriptContext(
        ...
        assertTrue(script.contains("window.Wammy = window.Wammy || {}"))
    ...
    @Test
    fun `buildWammyScript seeds the new runtime state`() {
        val script = NovelWebViewChapterMeta.buildWammyScript(
            NovelWebViewChapterMeta.WammyScriptContext(
                novelUrl = null,
                currentChapter = null,
    ...
    @Test
    fun `buildWammyScript runtime flags reflect context booleans`() {
        val script = NovelWebViewChapterMeta.buildWammyScript(
            NovelWebViewChapterMeta.WammyScriptContext(
                novelUrl = null,
                currentChapter = null,
    ...
    @Test
    fun `buildWammyScript reflects isPagedMode on the pagingEnabled runtime key`() {
        val pagedOn = NovelWebViewChapterMeta.buildWammyScript(
            NovelWebViewChapterMeta.WammyScriptContext(
                novelUrl = null,
                currentChapter = null,
                chaptersInOrder = emptyList(),
        ...
        val pagedOff = NovelWebViewChapterMeta.buildWammyScript(
            NovelWebViewChapterMeta.WammyScriptContext(
                novelUrl = null,
                currentChapter = null,
                chaptersInOrder = emptyList(),
