...
class EpubWriterTest {
    ...
    // â”€â”€ detectImageType â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Cover MIME detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ EPUB 2 compatibility â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ EPUB 3 cover-image property â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Chapter image embedding â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fun `chapter image is written to correct EPUB path`() {
        ...
        val chapter = EpubWriter.Chapter(
            title = "Ch 1",
            content = """<img src="wammy-novel-image://image_0.jpg"/>""",
            images = listOf(img),
        )
    ...
    // â”€â”€ HTML rewriting â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    @Test
    fun `wammy-novel-image URLs are rewritten to EPUB-relative paths`() {
        val imgBytes = byteArrayOf(0xFF.toByte(), 0xD8.toByte(), 0xFF.toByte(), 0xE0.toByte(), 0, 0)
        val img = EpubWriter.EmbeddedImage(
            id = "image_0.jpg",
            bytes = imgBytes,
        ...
        assertFalse(chapterXhtml.contains("wammy-novel-image://"), "wammy-novel-image:// must be rewritten")
    ...
    fun `an image id containing a space still matches the percent-encoded src`() {
        ...
        val chapter = EpubWriter.Chapter(
            title = "Ch 1",
            content = """<img src="wammy-novel-image://cover%20art.jpg"/>""",
            images = listOf(img),
        )
        val chapterXhtml = buildEpub(chapters = listOf(chapter)).text("OEBPS/chapter0000.xhtml")
        assertFalse(chapterXhtml.contains("wammy-novel-image://"), "wammy-novel-image:// must be rewritten")
    ...
    @Test
    fun `orphan wammy-novel-image img tags are removed`() {
        // Image referenced in HTML but NOT provided in images list
        val chapter = EpubWriter.Chapter(
            title = "Ch 1",
            content = """<img src="wammy-novel-image://orphan.jpg"/>""",
            images = emptyList(),
        )
        val chapterXhtml = buildEpub(chapters = listOf(chapter)).text("OEBPS/chapter0000.xhtml")
    ...
    fun `picture element sources are stripped and img is kept`() {
        ...
        val chapter = EpubWriter.Chapter(
            title = "Ch 1",
            content = """<picture><source srcset="https://cdn.example.com/big.webp" type="image/webp"/><img src="wammy-novel-image://image_0.jpg"/></picture>""",
            images = listOf(img),
        )
    ...
    // â”€â”€ Required EPUB structure â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fun `chapter does not reference custom stylesheet when CSS is absent`() {
        ...
        assertFalse(
            ...
            "Chapter must not link wammy-style.css when CSS embedding is disabled",
        )
    }
    ...
    fun `every chapter includes script tag when JS is embedded`() {
        ...
        assertTrue(
            ...
            "Chapter 0 must reference wammy-script.js",
        )
        assertTrue(
            entries.text("OEBPS/chapter0001.xhtml").contains("""src="$expectedHref""""),
            "Chapter 1 must reference wammy-script.js",
        )
    }
    ...
    fun `bundled snippet paths match conventional EPUB layout`() {
        // Files should land under OEBPS/styles/ and OEBPS/scripts/ â€” common EPUB convention.
