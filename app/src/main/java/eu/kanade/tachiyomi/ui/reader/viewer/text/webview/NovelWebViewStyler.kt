...
internal class NovelWebViewStyler(
    ...
    fun injectScript(
        ...
        buildWammyScript: () -> String,
    ) {
        evaluateJs(buildWammyScript())
            ...
            (function(){
                ...
                for (var __i = 0; __i < __snippets.length; __i++) {
                    ...
                    __el.textContent = __snippets[__i].code +
                        '\n//# sourceURL=wammy-snippet-' + __snippets[__i].name + '.js';
    ...
    fun injectPagedReader() {
        val js = NovelWebViewJsAssets.loadWith(
            ...
            "paged-reader.js",
            mapOf(
                "WAMMY_OBJECT_NAME" to WAMMY_OBJECT_NAME,
                "CHAPTERS_CONTAINER_ID" to WAMMY_CHAPTERS_CONTAINER_ID,
    ...
    companion object {
        const val STYLE_ID_CUSTOM = "wammy-custom-style"
        ...
        const val FONT_URL_PREFIX = "https://wammy.font/custom"
