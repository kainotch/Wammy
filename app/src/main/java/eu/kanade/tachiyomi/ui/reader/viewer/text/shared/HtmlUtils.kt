...
object HtmlUtils {
    ...
    private fun markdownToHtml(markdown: String): String {
        return try {
            ...
            "<div data-wammy-markdown=\"1\">$rendered</div>"
        } catch (e: Exception) {
    ...
    private fun plainTextToHtml(text: String): String {
        ...
        return "<pre data-wammy-plain-text=\"1\" style=\"white-space: pre-wrap; word-break: break-word; overflow-wrap: anywhere; margin: 0;\">$escaped</pre>"
    }
