...
@Composable
private fun ColumnScope.NovelViewerSettings(viewModel: ReaderSettingsViewModel) {
    ...
    TapZonesItems(
        ...
        onSelect = viewModel.preferences.navigationModeNovel::set,
        invertMode = novelNavInverted,
        onSelectInvertMode = viewModel.preferences.novelNavInverted::set,
    )
}
