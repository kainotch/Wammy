...
android {
    ...
    if (System.getenv("WAMMY_GITHUB_RELEASE").toBoolean() &&
        System.getenv("GITHUB_REPOSITORY_OWNER") == "wammy-otaku"
    ) {
        val tempStoreFile = file(System.getenv("RUNNER_TEMP")).resolve("wammy.keystore")
